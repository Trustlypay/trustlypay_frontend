...
const ResellerStep1 = () => {
  ...
  const onFinish = () => {
    void form.validateFields().then(() => {
      ...
      navigate(`${routeMapMini.resellerStep2}?step=2`);
  ...
  return (
    <div className="main scrollbar" style={{ alignItems: "center" }}>
      <ResellerSteps />
      <div className="playfair-display-24">Reseller Details</div>
      <WhiteBorder />
      <Form
        style={{
          margin: "0px auto",
      ...
      >
        <div className="manrope-24">Personal Details</div>
        ...
        <div className="manrope-24">Company Details</div>
        <div className="form-grid-2">
          <Form.Item
            label="Company Name"
            name="companyName"
          ...
          >
            <Input placeholder="Enter  Monthly Expenditure" />
          </Form.Item>
          ...
          <Form.Item
            ...
            rules={[
              { required: true },
              {
                ...
                message: "Enter Valid Company PAN Number",
              },
              { whitespace: true },
            ]}
          >
          ...
          <Form.Item
            ...
            rules={[
              { required: true },
              {
                ...
                message: "Enter Valid Company GST Number",
              },
              { whitespace: true },
            ]}
          >
            <Input placeholder="Enter Company GST Number" />
          </Form.Item>
